...
object PrefabsPrompt {
    ...
    private const val OBRIGATORY_INFORMATION = "Informações obrigatórias para a notícia:\n" +
    ...
    private const val OPTIONAL_INFORMATION = "Informações opcionais para enriquecer a notícia:\n" +
    ...
    val PREFAB_CHANNEL_PROMPT =
        OBRIGATORY_INFORMATION +
                OPTIONAL_INFORMATION +
                "As informações sobre este bairro são as seguintes: %s. "
